      ...
      <div className="banner">
        <div className="container-fluid overlay  ">
          <div className="container text-center">
            ...
            <h3 > Rumah, Apatemen, Modern, Minimalis, Kontemporer, Mediteranian, Dll</h3>
            <br />
        ...
        <div className="container">
          <div className="row row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <p className="lead text-secondary my-5">Ingin menjadi vendor kami? Daftarkan vendor anda dan bergabunglah bersama kami
              </p>
